 ...
 */
public class SearchGroups2FirstPassResultTransformer implements ShardResultTransformer<List<Command>, Map<String, SearchGroupsFieldCommandResult>> {
  ...
  public SearchGroups2FirstPassResultTransformer(SolrIndexSearcher searcher) {
  ...
  public NamedList transform(List<Command> data) throws IOException {
    ...
    for (Command command : data) {
      ...
      if (SearchGroups2FieldCommand.class.isInstance(command)) {
        ...
        result.add(fieldCommand.getParentKey(), commandResult);
      } else {
