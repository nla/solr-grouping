 ...
 */
public class TopGroups2ShardResponseProcessor implements ShardResponseProcessor {
  ...
  public void process(ResponseBuilder rb, ShardRequest shardRequest) {
    ...
    for (ShardResponse srsp : shardRequest.responses) {
      ...
      NamedList<NamedList> thirdPhaseResult = (NamedList<NamedList>) srsp.getSolrResponse().getResponse().get("thirdPhase");
      if(thirdPhaseResult == null)
        continue;
