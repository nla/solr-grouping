 ...
 * @lucene.experimental
 */
public class FunctionFirstPassGrouping2Collector extends AbstractFirstPassGrouping2Collector<MutableValue> {
   ...
   */
  public FunctionFirstPassGrouping2Collector(SchemaField groupField, Sort groupSort, int topNGroups) throws IOException {
    super(groupSort, topNGroups);
    this.groupByVS = groupField.getType().getValueSource(groupField, null);
    this.vsContext = new HashMap<>();
  }
