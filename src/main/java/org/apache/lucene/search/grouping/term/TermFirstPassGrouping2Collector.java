 ...
 * @lucene.experimental
 */
public class TermFirstPassGrouping2Collector extends AbstractFirstPassGrouping2Collector<BytesRef> {
   ...
   */
  public TermFirstPassGrouping2Collector(String groupField, String groupParentField, Sort groupSort, int topNGroups) throws IOException {
