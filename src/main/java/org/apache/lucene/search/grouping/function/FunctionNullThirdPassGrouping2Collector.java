 ...
 * @lucene.experimental
 */
public class FunctionNullThirdPassGrouping2Collector extends AbstractThirdPassGrouping2Collector<MutableValue, MutableValue> {
  ...
  private FunctionNullThirdPassGrouping2Collector parent;

  @SuppressWarnings({"unchecked", "rawtypes"})
  public FunctionNullThirdPassGrouping2Collector(SchemaField groupParentField, Collection<CollectedSearchGroup2<MutableValue, MutableValue>> groups, 
