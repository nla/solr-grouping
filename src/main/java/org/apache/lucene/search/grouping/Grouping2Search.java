 ...
 * @lucene.experimental
 */
public class Grouping2Search {

  private final String groupField;
  private final String parentGroupField;
   ...
   */
  public Grouping2Search(String groupField, String parentGroupField) {
    this(groupField, parentGroupField, null, null, null);
  }
   ...
   */
  public Grouping2Search(ValueSource groupFunction, Map<?, ?> valueSourceContext) {
    this(null, null, groupFunction, valueSourceContext, null);
  }
   ...
   */
  public Grouping2Search(Query groupEndDocs) {
    this(null, null, null, null, groupEndDocs);
  }

  private Grouping2Search(String groupField, String parentGroupField, ValueSource groupFunction, Map<?, ?> valueSourceContext, Query groupEndDocs) {
  ...
  protected TopGroups groupByFieldOrFunction(IndexSearcher searcher, Query query, int groupOffset, int groupLimit) throws IOException {
    ...
    if (groupFunction != null) {
    	throw new IllegalStateException("Not supported FunctionFirstPassGroupingCollector");
...
//      }
    ...
    Collection<SearchGroup<BytesRef>> topSearchGroups = firstPassCollector.getTopGroups(groupOffset, fillSortFields);
    ...
    if (groupFunction != null) {
    	throw new IllegalStateException("FunctionSecondPassGroupingCollector not supported.");
//      secondPassCollector = new FunctionSecondPassGroupingCollector((Collection) topSearchGroups, groupSort, sortWithinGroup, topNInsideGroup, includeScores, includeMaxScore, fillSortFields, groupFunction, valueSourceContext);
      ...
      thirdPassCollector = new TermThirdPassGrouping2Collector(groupField, parentGroupField,(Collection) topSearchGroups, groupSort, sortWithinGroup, topNInsideGroup, includeScores, includeMaxScore, fillSortFields);
    }

    if (cachedCollector != null && cachedCollector.isCached()) {
      cachedCollector.replay(thirdPassCollector);
    } else {
      searcher.search(query, thirdPassCollector);
    }

    if (allGroups) {
      return new TopGroups(thirdPassCollector.getTopGroups(groupDocsOffset), matchingGroups.size());
    } else {
      return thirdPassCollector.getTopGroups(groupDocsOffset);
    }
  }
   ...
   */
  public Grouping2Search setCachingInMB(double maxCacheRAMMB, boolean cacheScores) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setCaching(int maxDocsToCache, boolean cacheScores) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search disableCaching() {
    this.maxCacheRAMMB = null;
    this.maxDocsToCache = null;
    return this;
  }
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setGroupSort(Sort groupSort) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setSortWithinGroup(Sort sortWithinGroup) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setGroupDocsOffset(int groupDocsOffset) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setGroupDocsLimit(int groupDocsLimit) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setFillSortFields(boolean fillSortFields) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setIncludeScores(boolean includeScores) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setIncludeMaxScore(boolean includeMaxScore) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setAllGroups(boolean allGroups) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setAllGroupHeads(boolean allGroupHeads) {
   ...
   * @return <code>this</code>
   */
  public Grouping2Search setInitialSize(int initialSize) {
